...
class Evaluator:
    ...
    def evaluate(self, dataloader, metric):
        ...
        if metric == "robustness_succ_w_sample_image":
            metric_fn = metric_fn_dict["robustness_succ"]
            return metric_fn(self.model, dataloader, view_sample_images=True, **self.metric_kwargs)
